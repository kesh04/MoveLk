...
import { useNavigation } from "@react-navigation/native";
import { EvilIcons } from "@expo/vector-icons";
import data from '../global/bus.json'; // Assuming data.json is in the same directory
    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <View>
          ...
          />
          <FontAwesome  style={{ position: "absolute", right: 36, top: 15.8 }} name="search"   onPress={handleSearch} size={24} color="black" />
